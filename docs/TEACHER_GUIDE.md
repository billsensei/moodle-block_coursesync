...
| **Quiz** | All the settings: timing, attempts, review rules, grading — and the questions, of the fourteen most common types | Questions of any other type, student attempts, and usage statistics |
...
| **Question bank** | Its categories, and questions of the fourteen most common types | Questions of any other type, attempts, and usage statistics |
...
activity — is only ever added once. Only the same fourteen question types
...
onto image, drag and drop markers, select missing words, ordering, random
short-answer matching and description are covered, background and drag
images included; anything else is named in the results, so you know it
did not come across. A random short-answer matching question picks its
...
above — only the fourteen most common question types travel, fixed or drawn
