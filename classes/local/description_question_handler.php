...
/**
 * Recreates a qtype_description "question" from
 * description_question_exporter's payload, via
 * \question_bank::get_qtype('description')->save_question().
 *
 * @package    block_coursesync
 * @copyright  2026 Course Sync contributors
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class description_question_handler implements question_handler {
    /**
     * Creates the question.
     *
     * @param array $data Payload from description_question_exporter::export().
    ...
    public function create(array $data, string $categoryspec): int {
        ...
        // Qtype_description::save_question() forces this to 0 itself regardless.
        $form->defaultmark = 0;
        $form->penalty = 0;

        $result = \question_bank::get_qtype('description')->save_question($question, $form);
