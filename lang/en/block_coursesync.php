...
$string['syncconfirmquestion'] = 'Copy new activities into this course now?';
...
$string['syncfullrecheckhint'] = 'Looks at every activity in the other course, not only what has changed. Anything already here is flagged rather than copied again.';
