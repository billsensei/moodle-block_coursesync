...
$string['syncalreadyhere'] = '{$a} more activities are already in this course, so they are not listed. Course Sync never copies one twice.';
...
$string['syncchoosecaption'] = 'Activities in the other course that are not in this one';
$string['syncchoosecolumn'] = 'Copy';
$string['syncchooseheading'] = 'Choose what to copy';
$string['syncchooseintro'] = 'These are in the other course but not in this one. Everything is ticked; untick anything you do not want. Whatever you leave out will be offered again next time.';
$string['syncchoosesubmit'] = 'Copy the ticked activities';
$string['synccollisions'] = '{$a->count} activities in this course already carry the identity of an activity on the other site, but Course Sync did not put them there: {$a->list}. They are not listed above and nothing will be changed or copied over them. Check them before syncing.';
