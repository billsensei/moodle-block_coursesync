...
$string['syncchoosecaptionpresent'] = 'Activities already in this course, shown for reference';
$string['syncchoosecolumn'] = 'Copy';
$string['syncchooseheading'] = 'Choose what to copy';
$string['syncchooseintro'] = 'Activities not yet in this course are listed below and start ticked, ready to copy; untick anything you do not want. Activities copied here before that have since changed in the other course can be updated too, but start unticked. What this course already has, unchanged, is listed further down for reference and cannot be ticked.';
