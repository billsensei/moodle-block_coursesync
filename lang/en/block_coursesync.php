...
$string['conflicts:confirmreplace'] = 'An activity already in this course has the same name or ID number as this one, and it was not created by this block. Taking the remote version will delete that activity, along with any work recorded against it, and put the remote copy in its place. This cannot be undone.';
...
$string['conflicts:willreplace'] = 'An activity this block did not create is in the way. Taking the remote version will delete it and everything recorded against it; you will be asked to confirm.';
